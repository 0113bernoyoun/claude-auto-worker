...
- **의존성**: TASK-081
- **완료 기준**:
  - [ ] `logs` tail 기본값/필터/lines 개선
  - [ ] `status` 상태 추정 정확도 향상(종료 코드/마지막 레벨)
  - [ ] 도움말/옵션 표기 일치화
...
#### TASK-052: 트리뷰(Workflows/Runs) 구현
- **예상 시간**: 12시간
- **담당 영역**: 확장 개발(UI)
- **의존성**: TASK-051
- **완료 기준**:
...
- 스트리밍 폴백/제어 (TASK-061)
 - Claude CLI 연동 보강/문서 (TASK-082, TASK-083, TASK-084)
